  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarNav">
      <ul className="navbar-nav">
        ...
        {/* <li className="nav-item">
        <button className="s"><Link className="nav-link" to="/Home"><span class="a">Login</span></Link></button>
        </li>
        <li className="nav-item">
        <button className="s"><Link className="nav-link" to="/Home"><span class="a">Register</span></Link></button>
        </li> */}
